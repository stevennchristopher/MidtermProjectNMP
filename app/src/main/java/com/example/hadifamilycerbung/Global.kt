...
object Global {
    val cerbung =
        arrayListOf(
            ...
            Cerbung(4, "https://picsum.photos/500", "Rahasia Gedung TF", 3, 2, 10, "\"Rahasia Gedung TF\" Gedung TF atau yang biasa disebut gedung teknik oleh warga sekitar, adalah bangunan yang selalu menyimpan sejuta misteri. Terletak di tengah Universitas Surabaya yang lebat, gedung ini sudah berdiri sejak bertahun-tahun, namun sampai saat ini hampir tidak ada yang tahu apa misteri di balik bangunan kuno tersebut")
        )
